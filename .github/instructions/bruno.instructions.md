---
description: 'Generic Bruno API client instructions that help GitHub Copilot to undrestand and generate Bruno collection and files for the Bruno API client. These instructions cover the OpenCollection specification, collection structure, request definitions, environment variables, scripting API, and best practices.'
applyTo: '**'
---
